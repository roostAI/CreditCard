...
# Test generated by RoostGPT for test weather-api-spec using AI Type Azure Open AI and AI Model roostgpt-4-32k
# 
...
# ********RoostGPT********
Feature: Real-time Weather API Tests
  ...
  Scenario Outline: Validate successful response for real-time weather API
  ...
  Scenario: Validate response for missing query parameter 'q'
    Given path 'v1/current.json'
    And header Accept = 'application/json'
    And param key = authToken
    When method GET
  ...
  Scenario: Validate response for missing or invalid API key
    Given path 'v1/current.json'
    And header Accept = 'application/json'
    When method GET
    Then status 401
  ...
  Scenario: Validate response for unauthorized API key
    Given path 'v1/current.json'
    And header Accept = 'application/json'
    And param key = 'invalid_token'
