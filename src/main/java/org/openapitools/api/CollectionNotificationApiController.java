...
public class CollectionNotificationApiController implements CollectionNotificationApi {

    private final NativeWebRequest request;

    @Autowired
    public CollectionNotificationApiController(NativeWebRequest request) {
